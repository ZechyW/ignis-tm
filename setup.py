...
setup(
    ...
    description="Iterative topic modelling platform",  # Optional
    ...
    url="https://github.com/ZechyW/ignis-tm",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Zechy Wong",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="zechywong@gmail.com",  # Optional
    ...
    # larger catalog.
    keywords="analytics, nlp, topic modelling",  # Optional
    ...
    #
    packages=find_packages(include=["ignis", "ignis.*"]),  # Required
